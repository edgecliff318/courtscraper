...
def update_stats(n):
    ...
    interactions_by_date.add_trace(
        px.bar(data.groupby("case_date").case_id.count(), title="Cases by date").data[0]
    )
                ...
                dbc.Card(
                    dbc.CardBody(
                        [
                            ...
                            html.H1(
                                f"{data.case_id.count():.0f}", className="display-3"
                            ),
                        ],
                ...
                dbc.Card(
                    dbc.CardBody(
                        [
                            ...
                            html.Hr(className="my-2"),
                            html.H1(total_cases_with_phone_nb, className="display-3"),
                        ],
                        className="text-center",
                    )
                ),
