...
class ScraperAZMaricopaJustice(ScraperBase):
    ...
    SEARCH_RESULT_URL = (
        "http://justicecourts.maricopa.gov/FindACase/caseSearchResults.asp"
    )
    ...
    def parse_case_document_information(self, soup):
        ...
        if not case_document_information_table:
            return []
        case_document_information_rows = (
            case_document_information_table.findAll("tr")
        )
    ...
    def parse_case_calendar_information(self, soup):
        ...
        if not case_calendar_information_table:
            return []
        case_calendar_information_rows = (
            case_calendar_information_table.findAll("tr")
        )
...
if __name__ == "__main__":
    ...
    print(
        ScraperAZMaricopaJustice().scrape(
            search_parameters={
                "firstName": "Christina",
                "lastName": "Banks",
                "dob": "10/22/1978",
