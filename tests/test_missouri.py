...
case_header = BeautifulSoup(
    open("mocks/missouri/case_header.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
dockets = BeautifulSoup(
    open("mocks/missouri/dockets.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
charges = BeautifulSoup(
    open("mocks/missouri/charges.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
services = BeautifulSoup(
    open("mocks/missouri/services.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
search_results = BeautifulSoup(
    open("mocks/missouri/search_results.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
