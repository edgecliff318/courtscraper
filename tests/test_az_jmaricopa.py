...
case_detail = BeautifulSoup(
    open("mocks/az_jmaricopa/case_detail.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
search_results = BeautifulSoup(
    open(
        "mocks/az_jmaricopa/search_results.html", "r+", encoding="utf-8"
    ).read(),
    features="html.parser",
)
...
def test_parse_disposition_information_for_scraper():
    """Tests scraper parsing functionality."""
    actual = ScraperAZMaricopaJustice().parse_disposition_information(
        case_detail
    )
...
def test_parse_case_document_information_for_scraper():
    """Tests scraper parsing functionality."""
    actual = ScraperAZMaricopaJustice().parse_case_document_information(
        case_detail
    )
...
def test_parse_case_calendar_information_for_scraper():
    """Tests scraper parsing functionality."""
    actual = ScraperAZMaricopaJustice().parse_case_calendar_information(
        case_detail
    )
