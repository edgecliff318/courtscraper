...
case_detail = BeautifulSoup(
    open("mocks/tx_denton/case_detail.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
search_results = BeautifulSoup(
    open("mocks/tx_denton/search_results.html", "r+", encoding="utf-8").read(),
    features="html.parser",
)
...
def test_search_in_denton_tx_for_lambda():
    ...
    actual = ScraperTXDentonJustice().scrape(
        search_parameters={
            "firstName": "Adam",
            "lastName": "Smith",
            "dob": "03/28/1978",
